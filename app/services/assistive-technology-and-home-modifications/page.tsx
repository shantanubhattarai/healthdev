    ...
    <article className="px-4 pt-12 md:pt-0 container mx-auto">
      ...
      <section className="pt-12">
        ...
        <ul className="list-disc list-inside mt-2 text-zinc-800">
          ...
          <li>
            Collaboration with occupational therapists and other specialists to
            ensure personalised solutions
          </li>
          <li>
      ...
      <section className="pt-12">
        ...
        <ul className="list-disc list-inside mt-2 text-zinc-800">
          ...
          <li>
            Coordination with your NDIS plan and healthcare team for seamless
            support
          </li>
        </ul>
      </section>
