        ...
        <div className="keen-slider__slide rounded-md">
          <HelpCard label="Supported Independent Living" cardKey="sil">
            <p className="line-clamp-3">
              ...
              need. We provide tailored assistance in shared or individual
              living environments, guided by each participant&apos;s NDIS goals,
...
const HelpCard = ({
  ...
  return (
    <>
      <div
        className="h-[480px] lg:h-[640px] bg-cover bg-center text-white"
        style={{
          backgroundImage: `url(${
